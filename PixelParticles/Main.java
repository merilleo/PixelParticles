...
import PixelParticles.Draw.DrawingMethods.DrawSquare;
...
//        LinearField randomField = new LinearField(5.1F, 20,20, randomFieldObject, Settings.sketch);
//        Settings.ps.addForce(randomField);
//        PerlinFieldObject perlinFieldObject = new PerlinFieldObject(0.1F);
//        LinearField linearField = new LinearField(15.1F, 100,100, perlinFieldObject, Settings.sketch);
